...
OUT = ROOT / "reference/slb1.3_ancestry_benchmark.json"
REPORT = ROOT / "ANCESTRY_BENCHMARK.md"
...
def audit() -> dict:
    ...
    return {
        "protocol": cfg,
        "provenance": {
            "benchmark": E.BENCH.name, "split": "test", "scorer_version": E.SCORER_VERSION,
            ...
            "rebuild_command": "SLB_BENCH=data/bench/slb1.3 uv run python scripts/benchmark_ancestry.py",
        },
...
def render(result: dict) -> str:
    ...
    lines = [
        ...
        " in [BENCHMARK.md](BENCHMARK.md#label-rules); all included sources passed"
        " [REPLICATION.md](REPLICATION.md). Cell-line ancestry is not patient race or"
        ...
        " [`reference/slb_ancestry_protocol_v1.json`](reference/slb_ancestry_protocol_v1.json).", "",
        "This protocol was written **after** the SLB-1.3 test readout; it is a"
    ...
    lines += ["", "The three-row `flister2025,harle2025` lung block has no EAS"
              ...
              " [`reference/slb1.3_ancestry_benchmark.json`](reference/slb1.3_ancestry_benchmark.json).", "",
