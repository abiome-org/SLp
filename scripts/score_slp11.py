"""Score SLB-1 human pairs with the frozen SLp-1.1 world model (abiome-org/slp, HF potteryrage/SLp).

Run with the old repo's environment:
    external/old-slp/.venv/bin/python scripts/score_slp11.py IN.tsv OUT.tsv
...
BUNDLE = Path("external/old-slp/results/slp11-transition/cellular-genomic-world-predictor-v2").resolve()
