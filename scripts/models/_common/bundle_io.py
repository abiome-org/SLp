...
Environment: SLB_BENCH (default data/bench/slb1.2), SLB_SPLIT (default dev), SLB_BUNDLE (default
...
RESULTS = Path(os.environ["SLB_OUT"]) if os.environ.get("SLB_OUT") else (
    ROOT / "results/models" if BENCH.name == "slb1.2" else ROOT / "results/models" / BENCH.name)
