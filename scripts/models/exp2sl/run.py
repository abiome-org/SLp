...
Variants:
  exp2sl__cellline  one model per SLB context that is an L1000 cell line with shRNA CGS (A-375, A-549, HT-29 in
                    SLB-1.2), trained on that context's SLB train rows (as in the paper: cell-line-specific)
