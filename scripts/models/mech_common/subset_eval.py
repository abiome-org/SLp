"""SLB dev metrics restricted to the examples a model actually covers (uses slpbench's own eval machinery).
...
from slpbench.evaluate import _auc, headline, load_gold
