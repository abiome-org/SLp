"""Reproduce the frozen SLB-1.3 dev search ledger; this script reads dev labels only."""
...
def main() -> None:
    if E.BENCH.name != "slb1.3":
        raise ValueError("this ledger is frozen for SLB-1.3")
