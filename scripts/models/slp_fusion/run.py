"""Frozen SLB-1.3 dev-selected rank blend; consumes only base-model predictions.
...
def blend(split: str, variant: str) -> tuple[pl.DataFrame, dict]:
    if BENCH.name != "slb1.3":
        raise ValueError("this frozen recipe was selected for SLB-1.3")
