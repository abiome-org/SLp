"""Control transition with a consistent decoder of latent state changes.

This module deliberately matches the original transition candidate's action,
context, query, and transition topology. Unlike revision v2, the molecular
change decodes the latent intervention delta, never the total basal state
with an external action-presence gate.
"""
