...
def resume_basal_perturbseq(data_dir,model_path,out_dir,dependency_epochs=3,perturb_epochs=10,perturb_rl_epochs=3,outcome_epochs=6,d=384,latent=128,layers=6,feature_name="features_spectral_safe.npz",evaluate_cv3=False,perturb_name="perturbseq_world_v3.npz"):
