"""Build SLB: measurements -> examples -> family-held-out splits.

    uv run python -m slbench.build            # all stages
    uv run python -m slbench.build --stage measurements|examples|splits
"""
...
def _single_effects(genes: pl.DataFrame) -> pl.DataFrame:
    ...
    from slbench.fitness import gene_effects
